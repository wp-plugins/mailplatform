...
<form method="post" action="options.php" id="mailplatform-db-options-form"
	...
	<div class="sidebar-box">
		<div class="sidebar-content">
			...
			<label class="mailplatform-feed-labels">
				...
				<input name="mailplatform_posts" type="checkbox"
			...
			<label class="mailplatform-feed-labels">
				...
				<input name="mailplatform_pages" type="checkbox"
			...
			<?php if ( class_exists( 'WooCommerce' ) ) { ?>
				<label class="mailplatform-feed-labels">
					...
					<input name="mailplatform_woocommerce" type="checkbox"
